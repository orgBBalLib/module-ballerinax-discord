...
[Discord](https://discord.com/) is a popular communication platform designed for creating communities, enabling users to communicate via text, voice, and video channels while offering powerful tools for community management and engagement.
...
2. The Discord API is available to all Discord users at no cost. There are no subscription plan restrictions for accessing the API, though rate limits apply based on your application's usage.
...
2. Click on the **New Application** button in the top-right corner and provide a name for your application, then click **Create**.
...
> **Tip:** You must copy and store this key somewhere safe. It won't be visible again in your account settings for security reasons. If you lose your token, you will need to regenerate a new one.
## Quickstart
