...
[Discord](https://discord.com/) is a communication platform that brings communities together through text, voice, and video chat, enabling millions of users to connect, collaborate, and build thriving communities around shared interests.
...
3. In the left sidebar of your application's page, select **Bot**.

4. Click the **Reset Token** button (or **Add Bot** if creating for the first time), then confirm by clicking **Yes, do it!**.

5. Your bot token will be displayed. Click **Copy** to copy the token to your clipboard.
